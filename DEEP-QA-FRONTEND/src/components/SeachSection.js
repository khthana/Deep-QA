      ...
      {addBtAction && (
        <div className="flex flex-row gap-2">
          <button
            ...
            type="button"
            disabled={isDisable}
            className={`flex items-center justify-center rounded-lg px-5 py-2.5 text-center font-medium text-white transition-all active:scale-95 ${
              isDisable
          ...
          <button
            ...
            type="button"
            disabled={isDisable}
            className={`flex items-center justify-center rounded-lg px-5 py-2.5 font-medium text-white transition-all active:scale-95 ${
              isDisable
                ? 'cursor-not-allowed bg-gray-400'
