...
will cost time — as of 24 September 2569 that is
`2026-09-24-the-mutant-that-found-a-missing-row.md`. Read it before taking work. Each handoff names the one it supersedes for state,
