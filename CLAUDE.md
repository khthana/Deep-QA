...
will cost time — as of 17 September 2569 that is
`2026-09-17-one-comparison-answers-for-every-control.md`. Read it before taking work. Each handoff names the one it supersedes for state,
